<footer>
    <div class="section-container pd-r-70 pd-l-70 mr-b-50">
        <div class="ft-logo-bar mr-t-20 mr-b-40">
            <img src="{{ asset('images/footer-logo.png') }}" class="ft-logo">
        </div>
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="ft-content-area">
                    ...
                    <div class="ft-contect-bar">
                        <div class="tell-box"><p class="contect-title">Telefon:</p>
                            <p class="contect-text">08561 / 9186035</p></div>
                        <div class="email-box"><p class="contect-title"> Email:</p>
                            <p class="contect-text">info@ kuenzel-investments.de</p></div>
                    </div>
    ...
    <div class="footer-bottom-bar"><p>Copyright © 2022 – Künzel Investments</p></div>
</footer>
