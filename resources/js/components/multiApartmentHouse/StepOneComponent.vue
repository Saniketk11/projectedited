                ...
                <div class="steps__inner">
                    <div class="form-group form__group">
                        <div class="position-relative">
                            <input type="number" placeholder="Einheiten"
                                   @keyup="setValue('apartment_count', $event.target.value)"
                                   :value="VALUES.apartment_count"
                                   :class="{'form-control': true, 'form__control': true, 'error' : errors.includes('apartment_count')}">
                        </div>
                        <small v-if="errors.includes('apartment_count')" class="error__message">Ihre Eingabe ist nicht
                            korrekt</small>
                    </div>
                    ...
                    <div class="form-group w-100">
                        <p>Teilungserklärung</p>

                        <div class="row">
                            <div class="col-sm-6">
                                <div class="radio__wrapper mt-0">
                                    <input type="radio" name="select"
                                           @change="setValue('is_declaration_of_division', 1)"
                                           id="option-3" :checked="VALUES.is_declaration_of_division">
                            ...
                            <div class="col-sm-6">
                                <div class="radio__wrapper mt-0">
                                    <input type="radio" name="select" id="option-4"
                                           @change="setValue('is_declaration_of_division', 0)"
                                           :checked="!VALUES.is_declaration_of_division">
...
export default {
    ...
    methods: {
        ...
        nextStep() {
            ...
            if (this.VALUES.apartment_count === '') {
                this.errors.push('apartment_count')
            }
